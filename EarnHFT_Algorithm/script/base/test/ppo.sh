function test_BTCTUSD() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        log_filename="log/base/BTCTUSD/test_ppo_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/ppo_test.py \
...
function test_BTCUSDT() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        target_path=$1"/"$element
        log_filename="log/base/BTCUSDT/test_ppo_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/ppo_test.py \
...
function test_ETHUSDT() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        target_path=$1"/"$element
        log_filename="log/base/ETHUSDT/test_ppo_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/ppo_test.py \
...
function test_GALAUSDT() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        target_path=$1"/"$element
        log_filename="log/base/GALAUSDT/test_ppo_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/ppo_test.py \
...
BTCTUSD_dir="result_risk/BTCTUSD/ppo/seed_12345"
BTCUSDT_dir="result_risk/BTCUSDT/ppo/seed_12345"
ETHUSDT_dir="result_risk/ETHUSDT/ppo/seed_12345"
GALAUSDT_dir="result_risk/GALAUSDT/ppo/seed_12345"

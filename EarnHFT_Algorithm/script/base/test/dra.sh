function test_BTCTUSD() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        log_filename="log/base/BTCTUSD/test_dra_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/dra_test.py \
...
function test_BTCUSDT() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        target_path=$1"/"$element
        log_filename="log/base/BTCUSDT/test_dra_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/dra_test.py \
...
function test_ETHUSDT() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        target_path=$1"/"$element
        log_filename="log/base/ETHUSDT/test_dra_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/dra_test.py \
...
function test_GALAUSDT() {
    ...
    for element in $(ls $1 | sort -t '_' -k2 -n); do
        ...
        target_path=$1"/"$element
        log_filename="log/base/GALAUSDT/test_dra_$element.log"
        CUDA_VISIBLE_DEVICES=$cuda_number nohup python RL/agent/base/dra_test.py \
...
BTCTUSD_dir="result_risk/BTCTUSD/dra_short/seed_12345"
BTCUSDT_dir="result_risk/BTCUSDT/dra_short/seed_12345"
ETHUSDT_dir="result_risk/ETHUSDT/dra_short/seed_12345"
GALAUSDT_dir="result_risk/GALAUSDT/dra_short/seed_12345"

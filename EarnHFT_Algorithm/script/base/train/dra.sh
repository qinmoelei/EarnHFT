CUDA_VISIBLE_DEVICES=0 nohup python RL/agent/base/dra_train.py \
    --dataset_name BTCTUSD --train_data_path data/BTCTUSD/train --transcation_cost 0 --max_holding_number 0.01 \
    >log/base/BTCTUSD/train_dra_short.log 2>&1 &


CUDA_VISIBLE_DEVICES=1 nohup python RL/agent/base/dra_train.py \
